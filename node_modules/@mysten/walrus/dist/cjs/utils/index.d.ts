...
export declare function getShardIndicesByNodeId(committee: InferBcsType<ReturnType<typeof Committee>>): Map<string, number[]>;
export declare function nodesByShardIndex(committee: InferBcsType<ReturnType<typeof Committee>>): Map<number, string>;
