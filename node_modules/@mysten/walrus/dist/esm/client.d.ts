...
import type { CertifyBlobOptions, ComputeBlobMetadataOptions, DeleteBlobOptions, ExtendBlobOptions, GetBlobMetadataOptions, GetSecondarySliverOptions, GetSliversOptions, GetStorageConfirmationOptions, GetVerifiedBlobStatusOptions, ProtocolMessageCertificate, ReadBlobOptions, RegisterBlobOptions, SliversForNode, StorageWithSizeOptions, WalrusClientConfig, WalrusClientExtensionOptions, WriteBlobAttributesOptions, WriteBlobOptions, WriteBlobToUploadRelayOptions, WriteEncodedBlobOptions, WriteEncodedBlobToNodesOptions, WriteMetadataOptions, WriteSliverOptions, WriteSliversToNodeOptions } from './types.js';
export declare class WalrusClient {
     ...
     * ```
     */
    createStorage({ size, epochs, walCoin, owner }: StorageWithSizeOptions): (tx: Transaction) => Promise<TransactionResult>;
    /**
     ...
     * ```
     */
    registerBlob({ size, epochs, blobId, rootHash, deletable, walCoin, owner, attributes, }: RegisterBlobOptions): (tx: Transaction) => Promise<TransactionResult>;
     ...
     * ```
     */
    extendBlob({ blobObjectId, epochs, endEpoch, walCoin, owner }: ExtendBlobOptions): (tx: Transaction) => Promise<void>;
    /**
